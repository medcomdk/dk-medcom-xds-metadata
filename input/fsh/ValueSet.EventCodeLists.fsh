...
* $MedComEventCodeOID#MCS88100 "Lunge—Lungefunktionsundersøgelse COPD FEV6; vol. = ? L"
* $MedComEventCodeOID#MCS88015 "Lunge—Lungefunktionsundersøgelse FEV1; vol. = ? L"
* $MedComEventCodeOID#MCS88019 "Arm—Blodtryk(systolisk) hjemme; tryk = ? mmHg"
* $MedComEventCodeOID#MCS88020 "Arm—Blodtryk(diastolisk) hjemme; tryk = ? mmHg"
* $MedComEventCodeOID#MCS88050 "Pt—Rejse sætte sig testen; antal (værdi 0-50) = × 1/30s"
* $MedComEventCodeOID#MCS88137 "Pt—COPD Assessment Test (CAT) score; antal(værdi 0-40) = ?"
* $MedComEventCodeOID#MCS88021 "Pt(KOL) —MRC skala; arb.antal(værdi 1-5) = ?"
* $hoer#1 "Audiogram"
