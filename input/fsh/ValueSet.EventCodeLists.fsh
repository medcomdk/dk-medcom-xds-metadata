...
* $MedComOID#MCS88019 "Arm—Blodtryk(systolisk) hjemme; tryk = ? mmHg"
* $MedComOID#MCS88020 "Arm—Blodtryk(diastolisk) hjemme; tryk = ? mmHg"
* $MedComOID#MCS88050 "Pt—Rejse sætte sig testen; antal (værdi 0-50) = × 1/30s"
* $MedComOID#MCS88137 "Pt—COPD Assessment Test (CAT) score; antal(værdi 0-40) = ?"
* $MedComOID#MCS88021 "Pt(KOL) —MRC skala; arb.antal(værdi 1-5) = ?"
* $hoer#1 "Audiogram"
