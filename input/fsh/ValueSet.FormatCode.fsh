...
* ^status = #active
* ^date = "2022-01-26"
* MedComIHE_FormatCode#urn:ad:dk:medcom:apd-v2.0.1:full "DK APD schema" //12-05-2020
* MedComIHE_FormatCode#urn:ad:dk:medcom:appointmentsummary:full "DK Appointment Summary Document schema" //08-06-2016
...
* ^status = #active
* ^date = "2022-01-26"
* MedComIHE_FormatCode#urn:ad:dk:medcom:qrd-v1.1:full "DK QRD schema"
* MedComIHE_FormatCode#urn:ad:dk:medcom:qrd-v1.2:full "DK QRD schema" //19-05-2015
* MedComIHE_FormatCode#urn:ad:dk:medcom:qrd-v1.3:full "DK QRD schema" //11-02-2022
*/
